...
dataset = create_dataset(dataset_path, raw=False, deletedups=False, randomize=False)
...
sns.heatmap(means, annot=True, fmt='.2f', linewidths=.1, linecolor='black', cmap="YlGnBu")
plt.title('Mean value plot')
plt.show()
